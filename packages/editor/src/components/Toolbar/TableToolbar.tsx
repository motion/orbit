import { AlignCenterIcon, AlignLeftIcon, AlignRightIcon, InsertAboveIcon, InsertBelowIcon, InsertLeftIcon, InsertRightIcon, TrashIcon } from 'outline-icons'
...
class TableToolbarComponent extends React.Component<Props> {
...
export const TableToolbar = withTheme(TableToolbarComponent)
