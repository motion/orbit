...
import { BaseRules, KeyframeRules, RawRules } from './rules.js'
...
> {
  ...
  generateClassnames(_: Props, _2: Props | null): void {
...
function createStyledComponent(
  ...
  class Constructor<Props extends Object> extends StyledComponentBase<Props> {
