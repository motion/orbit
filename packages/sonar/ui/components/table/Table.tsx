...
type TableProps = {
   ...
   * Highlighted rows.
   */
  highlightedRows?: TableHighlightedRows | null
  /**
   * Callback when the highlighted rows change.
   */
  onHighlight?: TableOnHighlight | null
  /**
   ...
   * Sort order.
   */
  sortOrder?: TableRowSortOrder | null
  /**
   * Callback when the sort order changes.
   */
  onSort?: TableOnSort | null

  /**
   * Order of columns.
   */
  columnOrder?: TableColumnRawOrder | null
  /**
   * Callback when a column is reordered or visibility changed.
   */
  onColumnOrder?: TableOnColumnOrder | null

  /**
   * Size of the columns.
   */
  columnSizes?: TableColumnSizes | null
  /**
   * Callback for when a column size changes.
   */
  onColumnResize?: TableOnColumnResize | null
  /**
...
export default class Table extends PureComponent<TableProps, TableState> {
  ...
  onDragSelect = (e: any, key: string, index: number) => {
