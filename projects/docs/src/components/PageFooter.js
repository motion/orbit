      ...
      <footer className="bs-docs-footer" role="contentinfo">
        <div className="container">
          ...
          <p>
            ...
            <a href="https://getbootstrap.com/docs/3.3/" rel="noopener noreferrer" target="_blank">
              bootstrap
            </a>
            ; licensed under{' '}
            <a
          ...
          <ul className="bs-docs-footer-links muted">
            ...
            <li>·</li>
            <li>
              <a href="https://github.com/react-bootstrap/react-bootstrap/">GitHub</a>
            </li>
            <li>·</li>
            <li>
            ...
            <li>·</li>
            <li>
              <a href="https://github.com/react-bootstrap/react-bootstrap/releases">Releases</a>
            </li>
          </ul>
        </div>
      </footer>
