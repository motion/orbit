...
If you have downloaded the Orbit.app and have set up your workspace, you can create a new
app using the interface. If you are so inclined, you may also use the CLI instructions found below.
