...
export class Repository<T> {
   ...
   */
  count(
    optionsOrConditions?: FindOptions<T> | DeepPartial<T>,
  ): Promise<number> {
  ...
  findAndCount(
    ...
    return this.provider.execute(this.name, 'findAndCount', [
      optionsOrConditions,
    ])
  }
  ...
  findByIds(
    ...
    return this.provider.execute(this.name, 'findByIds', [
      ids,
      optionsOrConditions,
    ])
  }
   ...
   */
  findOne(
    idOrOptionsOrConditions?: string | number | FindOptions<T> | DeepPartial<T>,
    maybeOptions?: FindOptions<T>,
  ): Promise<T | undefined> {
    return this.provider.execute(this.name, 'findOne', [
