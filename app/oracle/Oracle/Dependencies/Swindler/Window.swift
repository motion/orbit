...
>: WindowDelegate, PropertyNotifier
    ...
    fileprivate var watchedAxProperties: [AXNotification: [PropertyType]]!
    ...
    fileprivate init(appDelegate: ApplicationDelegate,
        ...
        let (initPromise, fulfill, reject) = Promise<[Attribute: Any]>.pending()
    ...
    func handleEvent(_ event: AXNotification, observer: Observer) {
        switch event {
