...
<div className="alt">Ergonomically though, we can do better.</div>
...
<div
  style={{
    maxHeight: '80vw',
    height: '547.33333px',
    background: `url(${require('./demo.jpg')}) no-repeat 50%`,
...
<div className="alt">Orbit Home with experimental Topic Explorer app.</div>
...
<div className="graphic">
  <div style={{ margin: '20px -20%', maxWidth: '100vw' }}>
    <img alt="On-Device = Data stays on your computer" src={require('./illustration.svg')} />
  </div>
</div>
...
<div
  style={{ width: 361, borderRadius: 20, overflow: 'hidden', position: 'absolute', right: -400 }}
>
  <img alt="Orbit Home" src={require('./nlp.jpg')} />
</div>
