...
export class Scrollable extends React.Component<Props, State> {
  element?: HTMLElement
  ...
  updateRightShadow() {
    const shadowRight = !!(this.element && this.element.scrollWidth > this.element.clientWidth)
  ...
  handleScroll = (ev: React.MouseEvent<HTMLElement>) => {
  ...
  render() {
    ...
    return (
      <Wrapper>
        <Scrolling ref={ref => (this.element = ref)} onScroll={this.handleScroll} {...rest}>
          {children}
        </Scrolling>
