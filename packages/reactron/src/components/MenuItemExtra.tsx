...
import { MenuItem } from '../componentIds'
...
export const Copy = props => <MenuItem role="Copy" accelerator="CmdOrCtrl+c" {...props} />
export const Paste = props => <MenuItem role="Paste" {...props} />
export const PasteAndMatchStyle = props => <MenuItem role="PasteAndMatchStyle" {...props} />
...
export const ToggleDevTools = props => <MenuItem role="ToggleDevTools" {...props} />
export const ToggleFullscreen = props => <MenuItem role="ToggleFullscreen" {...props} />
...
export const StartSpeaking = props => <MenuItem role="StartSpeaking" {...props} />
