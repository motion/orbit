...
export const SECTION_HEIGHT = Math.max(980, Math.min(1300, window.innerHeight))
...
export const backgroundColor = UI.color('#fff6fb')
...
export const colorSecondary = UI.color('rgb(29.1%, 79.2%, 54.8%)')
