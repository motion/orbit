We're introducing Orbit into private beta today after quite a long development period. I'm excited
...
<div className="graphic">
  <div style={{ margin: '20px -20%', maxWidth: '100vw' }}>
    <img
      width="100%"
      alt="On-Device = Data stays on your computer"
      src={require('./screen2.jpeg')}
    />
  </div>
</div>
