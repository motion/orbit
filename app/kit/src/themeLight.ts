...
export const light: ThemeObject = Object.freeze({
  ...
  ...fromStyles({
    ...
    borderColorActive: [200, 200, 200],
    borderColorHover: [200, 200, 200],
    borderColorLight: [200, 200, 200, 0.5],
    headerBackground: linearGradient([255, 255, 255, 0.2], [255, 255, 255, 0]),
