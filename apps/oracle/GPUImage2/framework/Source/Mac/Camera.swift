...
public class Camera: NSObject, ImageSource, AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate {
    ...
    let videoInput:AVCaptureScreenInput!
    ...
    public init(input: AVCaptureScreenInput) throws {
        self.inputCamera = AVCaptureDevice.defaultDevice(withMediaType:AVMediaTypeVideo)
        self.orientation = ImageOrientation.portrait
