There's a few problems with the way we build things today. I'll try and summarize them in two
sentences. We build apps that either are powerful but limited to a platform, or flexible but slow.
Building those apps involves an incredible amount of unnecessary work, and in the end they are often
deployed in complex ways, out of our control.
