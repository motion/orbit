...
@keydown
class LinkToolbarComponent extends React.Component<Props, State> {
  ...
  selectSearchResult = (ev: Event, url: string) => {
    ev.preventDefault()
    this.save(url)
  }
  ...
  render() {
    ...
    return (
      <span ref={this.setWrapperRef}>
        ...
        {hasResults && (
          <SearchResults>
            <ArrowKeyNavigation mode={ArrowKeyNavigation.mode.VERTICAL} defaultActiveChildIndex={0}>
...
export const LinkToolbar = withTheme(LinkToolbarComponent)
