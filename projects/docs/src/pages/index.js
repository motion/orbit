        ...
        <main id="rb-docs-content">
          <MastHead fluid>
            <Content>
              ...
              <div className="text-muted mt-3">Current version: {pkg.version}</div>
            </Content>
          </MastHead>
            ...
            <Row>
              <FeatureCard>
                ...
                <p>
                  ...
                  from scratch as true React components, without uneeded dependencies like jQuery.
                </p>
                <p>
                  As one of the oldest React libraries, react bootstrap has evolved and grown
                  along-side React, making it an exellent choice as your UI foundation.
                </p>
              </FeatureCard>
              ...
              <FeatureCard>
                ...
                <p>
                  By relying entirely on the Bootstrap stylesheet, React bootstrap, just works with
                  the thousands of bootstrap themes you already love.
                </p>
                <p />
              </FeatureCard>
