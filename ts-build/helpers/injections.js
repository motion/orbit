...
export const closeChromeTabWithUrl = (url) => __awaiter(this, void 0, void 0, function* () {
    yield Helpers.runAppleScript(`
...
export const openAuth = (url) => __awaiter(this, void 0, void 0, function* () {
    yield Helpers.runAppleScript(`
...
export const injectCrawler = _.throttle(() => __awaiter(this, void 0, void 0, function* () {
    const js = yield Helpers.getCrawler();
    yield Helpers.runAppleScript(`
    tell application "Google Chrome"
      tell front window's active tab
        set source to execute javascript "${Helpers.escapeAppleScriptString(js)}"
      end tell
    end tell
  `);
}), 500);
