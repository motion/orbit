We're excited to expand the Orbit private beta, starting today. We've been testing it with a few
teams over the last few months, and generally feel like it's ready for wider feedback.

So, what is Orbit?

Orbit is a really easy way to build the types of apps your team at work needs - ones that manage
data from a variety of sources, display it, let you update, manipulate, and visualize it, and
eventually export it.

I like to think of Orbit as **a studio where apps meet data**, or as the Bootstrap of internal
tools.
