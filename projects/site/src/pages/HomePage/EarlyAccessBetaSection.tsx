import { Button, Form, gloss, Image, Input, Space, Theme, View } from '@o/ui'
              ...
              >
                ...
                <View pad="lg">
                  <Form space="lg">
                    ...
                    <Button alt="orange" size={2} sizeRadius={2} margin={[0, '20%']}>
                      Signup
                    </Button>
                  </Form>
                </View>
