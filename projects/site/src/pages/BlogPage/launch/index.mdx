...
I want to focus in on how my thinking has changed the most over the years, alongside a retrospective
of how we got here.

Orbit is really a longshot. It's not a small thing, or one-thing-well. And I really wish there were
more attempts to make change in this way. Especially in software where we have so many big problems.
Programming is hard, but the reasons its hard are not entirely internal. They are at every level:
from the operating system up all the way through the editors we use.

I think part of the reason there isn't much innovation in these areas is because there just isn't a
great way to fund many of them, but also because these are the types of changes that take many years
of hard work to achieve.

**We have no good system for building truly ambitious companies, and the way we fund startups forces
them to solve only the lowest hanging fruit**.

Even YCombinator, founded on the right thesis that putting more smart people together to solve big
problems is a good thing, for some reason also hold the totally contradictoy belief that your
startup should be a toy, do one small thing well to start, etc.

I can understand the rationale that getting into the market somehow is a good thing, but that
doesn't preclude _also_ working and aiming at a big, hard thing.
