...
export declare const CheckBoxRow: ({ name, children, checked, onChange, }: React.HTMLProps<HTMLInputElement> & React.HTMLAttributes<any> & import("@mcro/css/_/cssPropertySet").OriginalCSSPropertySetStrict & {
