!(function(modules) {
  ...
  function(module, exports) {
    ...
    chrome.runtime.onConnect.addListener(function(port) {
      console.log('got a connect', port)
      var tab = null,
        name = null
      isNumeric(port.name)
        ? ((tab = port.name),
        ...
        : ((tab = port.sender.tab.id), (name = 'content-script')),
        ports[tab] ||
          (ports[tab] = {
            devtools: null,
            'content-script': null,
