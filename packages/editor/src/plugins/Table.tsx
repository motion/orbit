import { Change, Editor, Node } from 'slate'
  ...
  return {
    ...
    commands: {
      setColumnAlign(editor: Editor, align: string): Change {
        ...
        const columnCells = editor.getCellsAtColumn(pos.table, pos.getColumnIndex())
      ...
      clearSelected(editor: Editor, table: Node) {
        ...
        const previouslySelectedColumns = table.data.get('selectedColumns') || []
