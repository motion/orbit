...
export declare const TitleBar: ({ children, before, after, ...props }: {
    [x: string]: any;
    children?: any;
    before?: any;
    after?: any;
}) => JSX.Element;
export declare const TitleBarButton: React.ForwardRefExoticComponent<React.HTMLAttributes<any> & import("@mcro/css/_/cssPropertySet").OriginalCSSPropertySetStrict & {
    ...
    stretch?: boolean;
    tagName?: string;
    theme?: import("@mcro/gloss").ThemeObject;
    tooltip?: string;
...
export declare const TitleBarSpace: () => JSX.Element;
