...
public final class AXApplication: UIElement {
    ...
    /// Creates an `AXApplication` from a `NSRunningApplication` instance.
    /// - returns: The `AXApplication`, or `nil` if the given application is not running.
    ...
    /// Create an `AXApplication` from the process ID of a running application.
    /// - returns: The `AXApplication`, or `nil` if the PID is invalid or the given application
    ///            is not running.
    ...
    /// Creates an `AXApplication` for every running application with a UI.
    /// - returns: An array of `AXApplication`s.
    ...
    /// Creates an `AXApplication` for every running instance of the given `bundleID`.
    /// - returns: A (potentially empty) array of `AXApplication`s.
