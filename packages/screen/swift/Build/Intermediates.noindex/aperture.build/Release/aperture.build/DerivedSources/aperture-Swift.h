...
SWIFT_MODULE_NAMESPACE_PUSH("aperture")

/// A simple demonstration interface to the python module
SWIFT_PROTOCOL("_TtP8aperture12OCRInterface_")
@protocol OCRInterface
+ (id <OCRInterface> _Nonnull)createInstance SWIFT_WARN_UNUSED_RESULT;
- (NSArray<NSString *> * _Nonnull)ocrCharacters SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC8aperture8Recorder")
...
@interface Recorder (SWIFT_EXTENSION(aperture)) <AVCaptureVideoDataOutputSampleBufferDelegate>
...
SWIFT_CLASS("_TtC8aperture20ThresholdBelowFilter")
@interface ThresholdBelowFilter : CIFilter
...
SWIFT_CLASS("_TtC8aperture15ThresholdFilter")
...
SWIFT_CLASS("_TtC8aperture19ThresholdFilterEasy")
@interface ThresholdFilterEasy : CIFilter
@property (nonatomic, strong) CIImage * _Nullable inputImage;
@property (nonatomic, readonly, strong) CIImage * _Null_unspecified outputImage;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8aperture21ThresholdFilterStrong")
@interface ThresholdFilterStrong : CIFilter
@property (nonatomic, strong) CIImage * _Nullable inputImage;
@property (nonatomic, readonly, strong) CIImage * _Null_unspecified outputImage;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8aperture9WebSocket")
...
@interface WebSocket (SWIFT_EXTENSION(aperture))
...
SWIFT_PROTOCOL("_TtP8aperture17WebSocketDelegate_")
