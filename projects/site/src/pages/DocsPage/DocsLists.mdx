...
<Example examples={Ex} source={ExSource} id="Selection" name="Single Selection" />
...
<Example examples={Ex} source={ExSource} id="MultipleSelection" name="Multiple Selection" />
