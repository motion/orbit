import { BlockQuoteIcon, BulletedListIcon, CodeIcon, Heading1Icon, Heading2Icon, HorizontalRuleIcon, ImageIcon, OrderedListIcon, TableIcon, TodoListIcon } from 'outline-icons'
...
import { SlateNodeProps, Theme } from '../../types'
...
class BlockToolbarComponent extends React.Component<Props> {
  bar?: HTMLDivElement
  ...
  insertBlock = (options: Options, cursorPosition: 'before' | 'on' | 'after' = 'on') => {
  ...
  render() {
    ...
    return (
      <Bar {...attributes} ref={ref => (this.bar = ref)}>
        ...
        <Separator />
        {this.renderBlockButton('bulleted-list', BulletedListIcon, 'Start bulleted list')}
        {this.renderBlockButton('ordered-list', OrderedListIcon, 'Start numbered List')}
        ...
        {this.renderBlockButton('horizontal-rule', HorizontalRuleIcon, 'Add break')}
        {hasImageUpload && this.renderBlockButton('image', ImageIcon, 'Add image')}
        <HiddenInput
          type="file"
...
export const BlockToolbar = withTheme(BlockToolbarComponent)
