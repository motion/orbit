...
import VirtualListItem from '../VirtualList/VirtualListItem'
...
export const OrbitListItem = (props: any) => {
...
export const getNormalPropsForListItem = (normalized: NormalItem): ListItemProps<any> => ({
